      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li><Link href="#" className="hover:text-tertiary transition-colors">Landing Page</Link></li>
            <li><Link href="#" className="hover:text-tertiary transition-colors">Company Profile</Link></li>
            <li><Link href="#" className="hover:text-tertiary transition-colors">Web Application</Link></li>
            <li><Link href="#" className="hover:text-tertiary transition-colors">E-Commerce</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li><Link href="#" className="hover:text-tertiary transition-colors">Tentang Kami</Link></li>
            <li><Link href="#" className="hover:text-tertiary transition-colors">Portofolio</Link></li>
            <li><Link href="#" className="hover:text-tertiary transition-colors">Kontak</Link></li>
          </ul>
        </div>
      </div>
